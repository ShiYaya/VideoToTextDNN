...
def save_test_samples_lsmdc(samples_test, engine):  # for lsmdc16 challenge
    ...
    dict_path = os.path.join('/p/work2/projects/ryat/datasets/vid-desc/lsmdc16/pkls16', 'dict_vids_mapping.pkl')
...
def test_cocoeval():
    ...
    samples_valid = common.load_txt_file('./results/yao_base/valid_samples.txt')
...
def test_cocoeval_vtt():
    engine = data_engine.Movie2Caption('attention', 'lsmdc16',
                                       ...
                                       dec='standard', proc='nostd',
                                       n_frames=20, outof=None,
                                       data_dir='/p/work2/projects/ryat/datasets/vid-desc-wg/data/lsmdc16/full/',
                                       feats_dir='/p/work2/projects/ryat/datasets/vid-desc/lsmdc16/features_googlenet')
    samples_valid = common.load_txt_file(
        '/p/work2/projects/ryat/datasets/vid-desc-wg/results/lsmdc16/googlenet/Attention-V4/valid_samples.txt')
    samples_test = common.load_txt_file(
        '/p/work2/projects/ryat/datasets/vid-desc-wg/results/lsmdc16/googlenet/Attention-V4/test_samples.txt')
    samples_valid = [sample.strip() for sample in samples_valid]
    samples_test = [sample.strip() for sample in samples_test]
